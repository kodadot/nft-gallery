...
.o-btn {
  ...
  &.loading-with-label.o-btn--loading {
    ...
    &::after {
      @apply relative left-0 border-2 border-k-grey rounded-full border-r-transparent border-t-transparent my-0 mx-[3px] h-[1em] w-[1em];
    }
  }
