<template>
  <section class="terms mb-5">
    ...
    <p class="mb-4">
      ...
      <a href="mailto:info@kodadot.xyz">info@kodadot.xyz</a> or by mail to
      Proletarska cesta 4, Ljubljana 1000, Slovenia.
    </p>
    ...
    <div id="ip" class="mb-2">
      ...
      <p class="mb-4">
        ...
        <a href="mailto:info@kodadot.xyz">info@kodadot.xyz</a>. If we ever grant
    ...
    <div id="ppyes" class="mb-2">
      ...
      <p class="mb-4">
        ...
        laws in Germany, then through your continued use of the Services, you
        are transferring your data to Germany, and you expressly consent to have
        your data transferred to and processed in Germany.
      </p>
    </div>
    ...
    <div id="law" class="mb-2">
      ...
      <p class="mb-4">
        ...
        your country to residence. GenArt, Matej Nemček s.p. and yourself both
        agree to submit to the non-exclusive jurisdiction of the courts of
        Ljubljana, which means that you may make a claim to defend your consumer
        protection rights in regards to these Legal Terms in Slovenia, or in the
    ...
    <div id="disputes" class="mb-2">
      ...
      <p class="mb-4">
        ...
        clause constitutes acceptance. The seat of arbitration shall be Vaduz,
        Liechtenstein. The language of the proceedings shall be English.
