...
export function getApiParams(api: ApiPromise, call: Extrisic, isParaTeleport: string | undefined, account: string, amount: string): any[] {
  ...
  const dst = isParaTeleport
   ...
   const acc = { X1: { AccountId32: { id: api.createType('AccountId32', account).toHex(), network: 'Any' } } };
