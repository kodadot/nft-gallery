...
export const KODADOT_DAO = 'HguGafrfk8nRP9a4tgJf7hLvSSFie8GtkDjyWFHQ2kDUAMc'
const OFFSET_DAO = 'HguGafrfk8nRP9a4tgJf7hLvSSFie8GtkDjyWFHQ2kDUAMc'
const BASE_FEE = 0.1 // 50 cents
