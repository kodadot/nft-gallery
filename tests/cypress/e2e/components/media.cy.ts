describe('render Media.vue component', () => {
  it('should render basic image', () => {
    ...
    cy.waitForNetworkIdle('+(GET|HEAD)', '*', 1000)
    cy.getCy('0').find('img').should('exist')
  })

  it('should render 3D Model', () => {
    cy.visit(
    ...
    cy.getCy('item-collection').click()
    cy.waitForNetworkIdle('+(GET|HEAD)', '*', 1000)
    cy.getCy('0').find('model-viewer').should('exist')
  })
  ...
  it('should render audio', () => {
    ...
    cy.getCy('item-collection').click()
    cy.waitForNetworkIdle('+(GET|HEAD)', '*', 1000)
    cy.getCy('0').find('audio').should('exist')
  })
  ...
  it('should render video', () => {
    ...
    cy.getCy('item-collection').click()
    cy.waitForNetworkIdle('+(GET|HEAD)', '*', 1000)
    cy.getCy('0').find('video').should('exist')
  })
})
