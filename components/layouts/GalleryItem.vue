<template>
  <BaseGalleryItem
    ...
    <template v-slot:top v-if="message">
      <LazyJustMintedTokenMessage :name="name" />
    </template>
    ...
    <template v-slot:main>
      <div class="columns">
        <div class="column is-6">
          ...
          <Description v-if="!isLoading && meta.description" :value="meta.description" />
        </div>
...
import { fetchNFTMetadata, sanitizeIpfsUrl, resolveMedia, getSanitizer } from '../rmrk/utils'
