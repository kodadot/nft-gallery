<template>
  <div class="flex flex-col">
    ...
    <div class="flex gap-2 !mt-4">
      <NeoInput v-model="amount" class="!max-w-52" type="number" min="1" />
      <NeoButton no-shadow expanded class="!h-[unset]" @click="$emit('retry')">
...
import { CanvasPreviewItem, CapturePreviewItem } from './types'
