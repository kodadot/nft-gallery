...
const menuMarketplace: Menu[] = [
  {
    ...
    url: 'https://hello.kodadot.xyz/general-1/faq',
    external: true,
  },
  {
...
const menuKodadot: Menu[] = [
  {
    name: $i18n.t('about'),
    url: 'https://hello.kodadot.xyz/general/faq',
    external: true,
  },
  {
    name: $i18n.t('careers'),
...

  {
    ...
    url: 'https://hello.kodadot.xyz/technical/kodadots-programs/artist-referral-program',
    external: true,
  },
  {
...

  {
    ...
    url: 'https://hello.kodadot.xyz/technical/kodadots-programs/artist-ambassador-program',
    external: true,
  },

  {
    name: $i18n.t('ambassador program'),
    url: 'https://hello.kodadot.xyz/technical/kodadots-programs/ambassador-program',
    external: true,
  },
]
