<template>
  <div
    ...
    <div class="flex">
      <button @click="walletTab = 'SUB'">polakdot</button>

      <button @click="walletTab = 'EVM'">evm</button>
    </div>

    <template v-if="walletTab === 'SUB'">
      ...
      <div
        v-if="!showAccount"
        class="bg-k-grey-light p-4 flex items-center mx-6">
    ...
    <div v-else class="modal-card-body">
      <NeoButton variant="k-accent" no-shadow>
