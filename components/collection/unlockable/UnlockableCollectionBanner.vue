<template>
  <div class="collection-banner" :style="{ backgroundImage: `url(${banner})` }">
    ...
    <section class="h-[368px] lg:h-full">
      <div
        class="relative w-full mx-auto px-5 md:px-10 min-[1440px]:max-w-[1440px] h-full flex justify-end items-start flex-col md:justify-between md:items-end md:flex-row">
