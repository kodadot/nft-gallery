    ...
    <div class="card-content">
      <div class="content">
        ...
        <p class="subtitle is-size-6">
          <b>TAGS:</b>
          <b-taglist>
            <b-tag v-for="(tag, index) in tags" :key="index" type="is-dark">
              {{ tag }}
            </b-tag>
          </b-taglist>
        </p>
        ...
        <ArweaveLink
          ...
          label="animated" />
        <p v-if="imageId" class="subtitle is-size-6"><b>IPFS</b> :</p>

        <ol>
          <li v-for="gw in gwList" :key="gw">
            <a :href="gw + imageId" target="_blank" rel="noopener noreferrer"
              >Gateway</a
            >
          </li>
        </ol>
