...
export const NAME = 'Spring anime'
export const COLLECTION_ID = '21032023'
...
export const buildDescription = (options: Options): string => {
  const { gender, framing, art, style, having, wearing, lighting, inspiredBy } =
    options
  let base = `Konnichiwa! I am your ${NAME} ${gender} generated by artificial intelligence and I'm here to help you forget about the long winter.
    Are you ready to leave your coats in the closet?
