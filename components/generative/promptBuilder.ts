...
export const NAME = 'Lisbon summer'
export const COLLECTION_ID = '165'
export const BACKGROUND = 'Lisbon'
...
export const buildDescription = (options: Options): string => {
  const { gender, framing, art, style, having, wearing, lighting } = options
  let base = `Konnichiwa! I am your sweet anime ${gender} character generated by artificial intelligence during Lisbon Sub0 event.
