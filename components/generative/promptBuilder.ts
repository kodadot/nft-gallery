...
export const buildDescription = (options: Options): string => {
  const { gender, framing, art, style, having, wearing, lighting, inspiredBy } =
    options
  let base = `Konnichiwa!\n I am anime ${gender} generated by artificial intelligence and I really like you.\n
    I think we met at the Christmas party in SubWork, Bled 🇸🇮.\n
    I would like to tell you a secret about this picture:\n\n
    This adorable picture that you see is a ${framing} ${style} ${art} of me.\n
  `
  ...
  if (lighting) {
    base += `Why does this picture look soo interesting? I think that ${lighting} lighting gives it its own vibe.\n`
  }

  if (inspiredBy) {
    base += `To make it spicier, art was inspired by ${inspiredBy}.\n`
  }
