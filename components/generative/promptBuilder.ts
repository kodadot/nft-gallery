...
export const NAME = 'Denver anime'
export const COLLECTION_ID = '26022023'
...
export const buildDescription = (options: Options): string => {
  const { gender, framing, art, style, having, wearing, lighting, inspiredBy } =
    options
  let base = `Konnichiwa! I am your ${NAME} ${gender} generated by artificial intelligence and I have already fallen in love with you.
    I want to make your trip to Denver special.
