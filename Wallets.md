...
Sub wallet is the another Polkadot based wallet Extension it has very clean User interface and unlike Polkadot-js this wallet comes with in-built all in one UI where you Tranfer Receive and view your NFTs and Tokens within sub-wallet Extension
How to Set-up
Download [Sub-wallet-Extension](https://chrome.google.com/webstore/detail/subwallet-polkadot-wallet/onhogfjeacnfoofkfgppdlbmlmnplgbn)
Once it's Donwloaded Click on Sub-wallet Extension
Create a new wallet
Setup password
Copy Seed-phrase and Save it Safely
Continue
Congrats Your wallet is created
