<template>
  <div>
    ...
    <b-field label="ETH address in Substrate" grouped>
      <b-input class="toolbox-covert__eth-wrapper" placeholder="Substrate address" :value="convertedAddress" disabled />
      <p class="control">
        <b-button
          icon-left="copy"
...
export default class extends Vue {
  ...
  private convertedAddress: string = '';
